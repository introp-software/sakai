...
public class SkinnableOauth2Login extends HttpServlet implements Login {
	...
	public void sendResponse(LoginRenderContext rcontext, HttpServletResponse res, String template, String contentType)
			throws IOException {
		// headers
		if (contentType == null) {
	...
	protected String getPasswordResetUrl() {
		...
		if (passwordResetUrl == null) {
			...
			try {
				...
				log.warn(
						"No " + gatewaySiteId + " site found whilst building password reset url, set password.reset.url"
